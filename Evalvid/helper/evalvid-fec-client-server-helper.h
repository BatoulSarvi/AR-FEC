...
#ifndef EVALVID_FEC_CLIENT_SERVER_HELPER_H
#define EVALVID_FEC_CLIENT_SERVER_HELPER_H
...
namespace ns3 {
   ...
   */
class EvalvidFecServerHelper
{
public:
   /**
    * Create EvalvidFecServerHelper which will make life easier for people trying
    * to set up simulations with udp-client-server application.
    *
    */
  EvalvidFecServerHelper ();
    ...
    */
  EvalvidFecServerHelper (uint16_t port);
  ...
  Ptr<EvalvidFecServer> GetServer(void);
private:
  ObjectFactory m_factory;
  Ptr<EvalvidFecServer> m_server;
};
 ...
 *
 */
class EvalvidFecClientHelper
{

public:
  /**
   * Create EvalvidFecClientHelper which will make life easier for people trying
   * to set up simulations with udp-client-server.
   *
   */
  EvalvidFecClientHelper ();
  ...
  EvalvidFecClientHelper (Ipv4Address ip,uint16_t port);
...
#endif /* EVALVID_FEC_CLIENT_SERVER_H */
