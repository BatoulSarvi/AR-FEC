...
public:
  ...
  /**
   * \return the Counter for sent packets 
   */
  uint32_t GetSentPacket () const;

  /**
   * \return the Counter for sent I frames
   */
  uint32_t GetSentIFrame () const;

  /**
   * \return the Counter for sent I packets 
   */
  uint32_t GetSentIPacket () const;
...
private:
  ...
  // ofstream    m_sentFrameFile ; // frame info for postprocessing
  // uint32_t    m_sentIframe;   // counter for sent I frame
  // uint32_t    m_sentPBframe;   // counter for sent P and B frame
  // uint32_t    m_sentIpacket;  // counter for I packets 
};
