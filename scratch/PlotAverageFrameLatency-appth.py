...
# python3 ../scratch/PlotAverageFrameLatency-appth.py 
...
outputName = 'AverageFrameLatency-DiffAppTh'
...
appThreashold_array = sys.argv[11:]
...
for appThr in appThreashold_array:
	x_array.append(appThr)
	# print(len(data))
	for run in data:
		if (run['Title'] == appropriate_run_pattern_AFEC + "-" + str(distance) + "-" + str(appThr) + "-" + str(location_echo) + "-" + str(aat_factor)):      #a-FEC-0-No-Table-1-dis-appThreashold-locationEcho
			y_afec.append(float(run['Total_Average_Latency(s)']))
			y_afec_err.append(float(run['std_dev_latency(s)']))
		elif (run['Title'] == appropriate_run_pattern_AFEC_Low + "-" + str(distance) + "-" + str(appThr) + "-" + str(location_echo) + "-" + str(aat_factor)):
			y_afec_low.append(float(run['Total_Average_Latency(s)']))
			y_afec_low_err.append(float(run['std_dev_latency(s)']))
		elif (run['Title'] == appropriate_run_pattern_AFEC_High + "-" + str(distance) + "-" + str(appThr) + "-" + str(location_echo) + "-" + str(aat_factor)):
			y_afec_high.append(float(run['Total_Average_Latency(s)']))
			y_afec_high_err.append(float(run['std_dev_latency(s)']))
		elif (run['Title'] == appropriate_run_pattern_NoFEC_Low + "-" + str(distance) + "-" + str(appThr) + "-0"):
			y_nofec_low.append(float(run['Total_Average_Latency(s)']))
			y_nofec_low_err.append(float(run['std_dev_latency(s)']))
		elif (run['Title'] == appropriate_run_pattern_NoFEC_High + "-" + str(distance) + "-" + str(appThr) + "-0"):
...
ax.set_xlabel('λ (s)', labelpad=10, fontsize=14)
ax.set_ylabel('Average Frame Latency (s)', labelpad=10, fontsize=12)
ax.set_title('Average Frame Latency - ' + str(distance) + ' m', fontsize=15)
